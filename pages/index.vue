      ...
      <mdb-mask overlay="blue-slight" flexCenter>
        <mdb-row class="mb-5 pb-5 text-center white-text">
          <mdb-col md="12" xl="12" class="mx-auto">
            <h1 class="display-3 font-weight-bold animated fadeInDown">CSLMIS <a class="indigo-text">App</a></h1>
            <h5 class="font-weight-bold pt-md-5 pt-sm-2 pt-5 pb-md-5 pb-sm-3 pb-5 animated fadeInDown">Using Parallax. An MDB Pro Feature.</h5>
